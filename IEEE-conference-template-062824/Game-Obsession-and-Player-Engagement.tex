...
\author{\IEEEauthorblockN{1\textsuperscript{st} 2204857}
...
\begin{tabular}{ll}
\hline
Hypothesis & Hypothesis outcome \\ \hline
  H0         &    The Player will not fulfil any criteria, so there is no change plausible. \\
  H1         &    The Player will fulfil most of the criteria of game addiction mentioned in \cite{NHSHamp24}, though can pull away. \\
  H2        &     The Player will fulfil the criteria of H1 - can't pull away. This will fulfil all of the criteria in \cite{NHSHamp24} and be classed as addiction. \\              
\end{tabular}%
}
