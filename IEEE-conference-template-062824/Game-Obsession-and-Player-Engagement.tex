...
\subsection{Testing}
Unit Testing is conducted throughout the creation of the unity artefact for integers, floats, and bools, among other variables. 
\begin{figure}[H]
\begin{center}
...
This figure (\ref{tab:figure3}) shows how the process will go per participant:

\begin{figure}[H]
\includegraphics[width = \textwidth]{UMLProcess}
...
Throughout this study, I have had, in hindsight, multiple issues within it, mainly regarding the six subsections listed out below.
