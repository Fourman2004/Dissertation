...
This question had 17\% of the participants who did not play video games, though out of the participants that have, 49\% play approximately 2 hours on average, with 6\% playing 8 hours and 3\% playing for 10 hours. The remaining 25% has an average of 5 hours per day. Using this information, it can be assumed that gaming addiction affects 9\% if we are only going off of the hours one plays daily. It can be assumed based on this question alone that what causes game addiction is the amount of time played by the participant.\\
